...
Peer (resource form, recommended)
  ...
  claudemesh peer kick <p> [-y]    end session                (alias: kick)
  claudemesh peer disconnect <p> [-y] soft disconnect         (alias: disconnect)
  claudemesh peer ban <p> [-y]     ban + revoke               (alias: ban)
